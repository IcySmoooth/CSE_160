...
class Vector3 {
    ...
    normalize() {
        ...
        if (length === 0) {
          console.log("Cannot normalize, magnitde is 0.");
          return this;
        }
...
class VectorMatrix4 {
    ...
    ortho(left, right, bottom, top, near, far) {
      return this.concat(new VectorMatrix4().setOrtho(left, right, bottom, top, near, far));
    };
    ...
    frustum(left, right, bottom, top, near, far) {
      return this.concat(new VectorMatrix4().setFrustum(left, right, bottom, top, near, far));
    };
    ...
    perspective(fovy, aspect, near, far) {
      return this.concat(new VectorMatrix4().setPerspective(fovy, aspect, near, far));
    };
    ...
    rotate = function(angle, x, y, z) {
      return this.concat(new VectorMatrix4().setRotate(angle, x, y, z));
    };
    ...
    lookAt(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ) {
      return this.concat(new VectorMatrix4().setLookAt(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ));
    };
